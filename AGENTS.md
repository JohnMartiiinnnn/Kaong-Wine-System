...
*   **Actuators:**
    *   **PWM (Pin 25):** 4-wire Fan speed control. The pre-heating fan uses non-inverted PWM (0% speed = OFF, 100% speed = ON), while the fermentation fan uses inverted PWM (0% speed = ON/255 duty cycle, 100% speed = OFF/0 duty cycle).
