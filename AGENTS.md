...
*   **Liquid Transfer Drain-to-Empty Protocol**:
    ...
    *   **Drain-to-Empty Confirmation**: The system monitors volume change over a rolling window. A 15-second window (`TRANSFER_DRAIN_TIMEOUT_MS = 15000UL`, `TRANSFER_DRAIN_SETTLE_MS = 15000UL`) with volume delta < 0.05L confirms complete chamber evacuation once liquid transfer finishes.
