...
* **Flow-Sensor Drain-to-Empty and Dual-Stage Settle Verification (< 0.15L Delta)**
  ...
  * When bulk liquid is evacuated, pump cavitation produces intermittent bubbles and droplets. A 15-second rolling window (`TRANSFER_DRAIN_TIMEOUT_MS = 15000UL`, `TRANSFER_DRAIN_SETTLE_MS = 15000UL`) with volume delta < 0.05L confirms complete chamber evacuation once liquid transfer finishes.
