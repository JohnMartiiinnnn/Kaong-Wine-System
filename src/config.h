...
extern float chamberVolume[3];
extern bool dryElementAlarm;
const float MIN_HEATER_SAFE_VOLUME = 5.0f;
...
const uint32_t  TRANSFER_DRAIN_TIMEOUT_MS  = 20000;  // 20s of sub-threshold flow (< 0.15L delta) confirms chamber is completely drained
...
extern uint32_t tareSuccessMillis;
